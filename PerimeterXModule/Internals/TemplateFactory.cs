...
namespace PerimeterX
{
	abstract class TemplateFactory
	{
		...
		public static string getTemplate(string template, IPXConfiguration pxConfiguration, string uuid, string vid)
		{
		...
		private static IDictionary<String, String> getProps(IPXConfiguration pxConfiguration, string uuid, string vid)
		{
